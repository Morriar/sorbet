...
class Foo
  def test
    ...
    h.overloaded(1) # error: Expected `String` but found `Integer(1)` for argument `_0`
                    # should ask for string
    h.overloaded("1", 2) # error: Expected `Class` but found `String("1")` for argument `_0`
